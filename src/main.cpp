...
int64 nChainStartTime = 1422651600;
...
const string strMessageMagic = "PenCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in PenCoin
    bool fStrictPayToScriptHash = true; // Always active in PenCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "PenCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "PEN is our tool";
        CTransaction txNew;
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0x3016833dccde21193204aad4780cdfe94b0620b72b57a686f3a6fc0826fa1989"));
...
unsigned char pchMessageStart[4] = { 0xcb, 0xfb, 0xfa, 0xdb };
